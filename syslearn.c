...
#define SYSLEARN_ENABLE_STACKING	1
#define SYSLEARN_REPORT_DISABLED	0
#define SYSLEARN_REPORT_HIGH		1 //minutes
#define SYSLEARN_REPORT_MEDIUM		5 //minutes
#define SYSLEARN_REPORT_LOW		10//minutes
